              ...
              <mat.Paper className="home_content">
                <mat.Grid container spacing={4}>
                  ...
                  >
                    ...
                    >
                      INTERVIEWS <icon.ArrowForwardIos sx={{ fontSize: 14 }} />
                    </Link>
                  </mat.Grid>
                </mat.Grid>
              </mat.Paper>
              ...
              <mat.Grid container>
                ...
                <mat.Grid item md={6} xs={6} className="nxt_stop scale">
                  <img
                    ...
                    alt="faculty"
                  />
                  <h4 className="header_title" style={{ textAlign: "center" }}>
                    b.sc gradshow
                  </h4>
                </mat.Grid>
                <mat.Grid
        ...
        <mat.Grid container id="message">
          <mat.Grid item md={4} xs={12} className="message">
            <img
              ...
              style={{ objectFit: "contain" }}
              src={
                require(`../assets/images/${categories.message.asset}`).default
              }
              alt="faculty"
            />
          </mat.Grid>
          ...
          <mat.Grid item md={8} xs={12} className="message nxt_stop">
            ...
            <p style={{ textAlign: "justify" }}>{categories.message.content}</p>
          </mat.Grid>
        </mat.Grid>
      </div>
    );
